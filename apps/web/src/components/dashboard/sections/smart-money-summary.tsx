...
import { TrendingUp, TrendingDown, Landmark, Users, TriangleAlert } from 'lucide-react';
 ...
 */
export const SmartMoneySummary = memo(function SmartMoneySummary({ data }: SmartMoneySummaryProps) {
          ...
          <div className="flex items-center gap-1.5">
            {hasInsiderActivity ? (
              <>
                ...
                {netValue !== 0 && (
                  <span className={`font-mono text-xs ${netValue >= 0 ? 'text-success' : 'text-destructive'}`}>
